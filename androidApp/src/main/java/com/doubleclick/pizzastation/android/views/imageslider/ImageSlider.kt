package com.doubleclick.pizzastation.android.views.imageslider
...
import com.doubleclick.pizzastation.android.views.imageslider.adapters.ViewPagerAdapter
...
class ImageSlider @JvmOverloads constructor(
     ...
     */
    fun setImageList(imageList: List<OffersModel>) {
